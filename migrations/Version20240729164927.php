 ...
 */
final class Version20240729164927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE species (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, picture VARCHAR(1500) DEFAULT NULL, avis LONGTEXT DEFAULT NULL, category_id INT NOT NULL, type_id INT NOT NULL, INDEX IDX_A50FF71212469DE2 (category_id), INDEX IDX_A50FF712C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
