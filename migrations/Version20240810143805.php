 ...
 */
final class Version20240810143805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE species DROP avis');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE species ADD avis LONGTEXT DEFAULT NULL');
    }
}
